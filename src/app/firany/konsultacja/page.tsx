    ...
    <div className='min-h-screen py-10 px-4 md:px-8 lg:px-16 bg-[var(--light-gold)]'>
      ...
      >
        <p className='text-lg md:text-xl leading-relaxed p-6 bg-white rounded-lg shadow-md'>
          Nasz specjalista pomoże Ci dopasować odpowiednie firany do Twojego
        ...
        >
          ...
          <div className='mb-6'>
            ...
            >
              ...
              <option value='klasyczne-firany'>Klasyczne firany</option>
              <option value='zasłony-zaciemniajace'>
          ...
          <div className='mb-6'>
            <label
              ...
              className='block text-gray-700 mb-2 font-medium'
            >
              Wysokość od zaczepu firanki do podłogi (cm):
            </label>
            <input
              type='number'
              id='height'
