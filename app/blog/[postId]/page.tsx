        ...
        <div className='space-y-8'>
          ...
          <div className='border-b border-gray-200 pb-8'>
            <div className='flex items-start mb-4'>
              ...
              <div>
                ...
                <p className='text-sm text-gray-500'>25 października 2023</p>
              </div>
            </div>
            <p className='text-gray-700'>
              Świetny artykuł! Właśnie jestem w trakcie remontu salonu i te
              porady bardzo mi pomogą. Szczególnie podoba mi się pomysł z
              oświetleniem warstwowym.
            </p>
          </div>
          ...
          <div className='border-b border-gray-200 pb-8'>
            <div className='flex items-start mb-4'>
              ...
              <div>
                <p className='font-medium text-gray-900'>Jan Nowak</p>
                <p className='text-sm text-gray-500'>20 października 2023</p>
              </div>
            </div>
            <p className='text-gray-700'>
              Czy możesz polecić jakieś konkretne marki mebli w stylu
              minimalistycznym? Szukam czegoś wysokiej jakości, ale w rozsądnej
              cenie.
            </p>

            {/* Odpowiedź na komentarz */}
            <div className='mt-6 ml-12 pl-6 border-l-2 border-gray-100'>
              <div className='flex items-start mb-4'>
                ...
                <div>
                  <p className='font-medium text-gray-900'>Projektant Wnętrz</p>
                  <p className='text-sm text-gray-500'>20 października 2023</p>
                </div>
              </div>
              <p className='text-gray-700'>
                Oczywiście! Możesz zajrzeć do naszej sekcji "Marki" na stronie
                głównej, gdzie znajdziesz wiele inspirujących propozycji.
              </p>
            </div>
          </div>
        </div>
